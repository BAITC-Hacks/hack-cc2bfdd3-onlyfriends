...
- Обучение и выбор модели: цель строго раньше 2026-02-01 00:00 локального времени.
...
- Результат: прогнозы по каждой турбине, метрики по месяцам и горизонтам, журнал, сериализованная модель.
