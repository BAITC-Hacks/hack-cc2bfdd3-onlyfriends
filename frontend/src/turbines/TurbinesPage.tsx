...
interface Props { hour: ForecastHour; turbines: Turbine[]; selected: string[]; onSelection: (selected: string[]) => void; onView3D: () => void }
export function TurbinesPage({ hour, turbines, selected, onSelection, onView3D }: Props) {
