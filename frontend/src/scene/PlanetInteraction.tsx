...
export function PlanetInteraction({ children, motion, reset, zoom, onZoom }: { children: ReactNode; motion: boolean; reset: number; zoom: number; onZoom: (zoom: number) => void }) {
