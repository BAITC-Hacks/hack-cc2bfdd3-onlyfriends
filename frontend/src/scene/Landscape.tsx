...
export function Landscape({ hour, turbines, selected, onSelect, motion, showLabels, wind }: { hour: ForecastHour; turbines: Turbine[]; selected: string[]; onSelect: (id: string) => void; motion: boolean; showLabels: boolean; wind: WindAt }) {
  return <group>
