...
interface Props { hour: ForecastHour; selected: string[]; onSelect: (id: string) => void; environment: ForecastEnvironment; reset: number; zoom: number; onZoom: (zoom: number) => void; settings: DisplaySettings; wind: WindAt; offlineTurbineId: string | null }
export default function PlanetScene({ hour, selected, onSelect, environment, reset, zoom, onZoom, settings, wind, offlineTurbineId }: Props) {
